...
public class PacketCodeC {
    ...
    public PacketCodeC(){
        ...
        requestTypeMap.put(Command.GROUP_MESSAGE_REQUEST, SendToGroupRequestPacket.class);
        requestTypeMap.put(Command.GROUP_MESSAGE_RESPONSE, SendToGroupResponsePacket.class);
